		...
		{#if tab === 'add'}
			<div in:fly={{ y: 10, duration: 300 }} class="space-y-5">
				...
				<div class="grid grid-cols-1 md:grid-cols-4 gap-3 pt-6 border-t border-white/5">
					...
					<a
						class="md:col-span-1 py-4 flex items-center justify-center rounded-lg bg-white/5 hover:bg-white/10 border border-white/5 text-gray-400 hover:text-white font-bold font-['Rajdhani'] uppercase tracking-widest transition-all text-sm"
						href={`/dashboard`}
					>
						Done
					</a>
